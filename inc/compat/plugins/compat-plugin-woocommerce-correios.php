 ...
 */
class SimpleCheckout_WooCommerceCorreios extends SimpleCheckout
{
	...
	public function hooks()
	{
		...
		add_filter('sc_shipping_method_option_description', array($this, 'shipping_delivery_forecast'), 10, 2);
	}
...
SimpleCheckout_WooCommerceCorreios::instance();
