 ...
 */
class SimpleCheckout_CodeRockz_WooCommerceDelivery extends SimpleCheckout
{
	...
	{
		$compat_file = SimpleCheckout::$directory_path . 'inc/compat/plugins/compat-plugin-woo-delivery.php';
...
SimpleCheckout_CodeRockz_WooCommerceDelivery::instance();
