 ...
 */
class SimpleCheckout_Admin extends SimpleCheckout
{
	...
	public function add_settings_pages($settings)
	{
		...
		$settings[] = include self::$directory_path . 'inc/admin/admin-settings-simple-checkout.php';
	...
	{
		$links[] = sprintf('<a href="%s">%s</a>', admin_url('admin.php?page=wc-settings&tab=sc_checkout'), esc_html(__('Settings', 'simple-checkout')));
		return $links;
	}
}

SimpleCheckout_Admin::instance();
