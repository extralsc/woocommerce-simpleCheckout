...
<div class="fc-contact-login">
	...
	<div class="fc-contact-login__separator">
		<?php if ('yes' === get_option('woocommerce_enable_guest_checkout')) : ?>
			<span class="fc-contact-login__separator-text"><?php echo esc_html(apply_filters('sc_checkout_login_separator_text', _x('Or continue as a guest', 'Log in separator label at for when guest checkout is disabled', 'simple-checkout'))); ?></span>
		<?php else : ?>
			<span class="fc-contact-login__separator-text"><?php echo esc_html(apply_filters('sc_checkout_login_separator_text', _x('Or continue checkout below', 'Log in separator label at for when guest checkout is disabled', 'simple-checkout'))); ?></span>
		<?php endif; ?>
	</div>
